...
measurements from the WildFly model and sends them to a ["RHQ-Metrics server", "https://github.com/rhq-project/wildfly-monitor/wiki/RHQ" or ["InfluxDB", "https://github.com/rhq-project/wildfly-monitor/wiki/InfluxDB"]
...
["RHQ Metrics", link="https://github.com/rhq-project/rhq-metrics"] is not part of this module. It needs to be installed separately. Please consult the RHQ metrics documentation,
