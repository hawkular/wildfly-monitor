 ...
 * @author Heiko W. Rupp
 */
public class DiagnosticsWriteAttributeHandler extends RestartParentWriteAttributeHandler {

    public DiagnosticsWriteAttributeHandler(AttributeDefinition... definitions) {
        super(DiagnosticsDefinition.DIAGNOSTICS, definitions);
    }
